            ...
            <i className="fa-regular fa-user relative text-[20px] icon-header mx-9 pos" onClick={handleUserClick} id="user">
                {userOpen
                    ...
                    <ul className='flex flex-col text-zinc-700 absolute text-[16px] w-[110px] h-20 bg-slate-200 top-[33px] left-[-16px]'>
                        <li onClick={() => navigate('/signin')} className='p-3 hover:bg-zinc-300'><i class="fa-solid fa-right-to-bracket"></i> Sign In</li>
                        <li onClick={() => navigate('/signup')} className='p-3 hover:bg-zinc-300'><i class="fa-solid fa-user-tie"></i> Sign Up</li>
                    </ul>
                    :
                    null
                }
            </i>
            <i class="fa-solid fa-bars icon-header text-[20px] inline-block sm:hidden"></i>
        </div>
    )
}
